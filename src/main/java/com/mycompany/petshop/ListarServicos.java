 ...
 * @author dti
 */
public class ListarServicos extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tableListar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Preço (em R$)", "Tempo Estimado (em minutos)"
            }
        ) {
        ...
        lblTituloPagina.setText("Listar Serviços");
    ...
    private void btListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarActionPerformed
        ...
        for (Servico s : Persistencia.getServicos()) {
