 ...
 * @author Rocha
 */
public class ListarMeusAgendamentos extends javax.swing.JInternalFrame {

    private Usuario usuarioLogado;

    /**
     * Creates new form ListarMeusAgendamentos
     */
    public ListarMeusAgendamentos(Usuario usuarioLogado) {
    ...
    private void initComponents() {
        ...
        tableListar.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Pet", "Serviços", "Tempo Estimado (Total)", "Data e Hora", "Valor"
            }
        ) {
        ...
        lblTituloPagina.setText("Listar Meus Agendamentos");
    ...
    private void btListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarActionPerformed
        ...
        for (Agendamento ag : Persistencia.getAgendamentos()) {
            if (ag.getUsuarioId() == usuarioLogado.getId()) {
