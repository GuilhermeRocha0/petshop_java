...
public class ListarUsuarios extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        lblTituloPagina.setText("Listar Usuários");
    ...
    // Esse método é responsável em requisitar a lista de usuários da classe Persistencia e exibi-los na tela através da tabela
    private void btListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btListarActionPerformed
        javax.swing.table.DefaultTableModel model = (javax.swing.table.DefaultTableModel) tableListar.getModel();

        model.setRowCount(0);

        for (Usuario u : Persistencia.getLista()) {
            model.addRow(new Object[]{u.getNome(), u.getEmail(), u.getCpf()});
        }
